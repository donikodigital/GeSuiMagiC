// frontend/src/app/(app)/projects/[id]/deposits/page.tsx - v2.0
'use client';
  ...
  return (
    <div>
      ...
      {isError ? (
        ...
        <EmptyState
          title="Aucun depot"
          description={isClient ? 'Enregistrez un depot pour alimenter le portefeuille du chantier.' : 'Aucun depot enregistre pour ce chantier.'}
        />
      ) : (
        <>
