// ============================================================================
// frontend/src/components/dashboard/dashboard-hero.tsx - v1.0
...
export function DashboardHero({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0B1330] via-[#122057] to-[#1B2E6E] px-6 pb-8 pt-7 shadow-xl shadow-[#0B1330]/20 sm:px-9 sm:pb-10 sm:pt-8">
      ...
      {stats.length > 0 && (
        <div className="relative mt-6 flex flex-wrap gap-2.5">
          {stats.map((stat) => (
            <div key={stat.label} className="rounded-2xl border border-white/10 bg-white/5 px-3.5 py-2 backdrop-blur-sm">
